      ...
      <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-2 md:gap-16">
        <div className="relative">
          ...
          {about.paragraphs.map((text, i) => (
            <RevealOnScroll key={text.slice(0, 12)} delay={220 + i * 110} distanceY={30} scale={0.98}>
              <p className="mb-5 max-w-[520px] text-base leading-relaxed text-text-muted">{text}</p>
            </RevealOnScroll>
          ))}
        </div>
